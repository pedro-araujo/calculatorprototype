...
public class prototypePadViewPager extends ViewPager {
    ...
    public prototypePadViewPager(Context context) {
        this(context, null);
    }

    public prototypePadViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
