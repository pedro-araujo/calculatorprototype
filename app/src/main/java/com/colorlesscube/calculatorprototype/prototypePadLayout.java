 ...
 */
public class prototypePadLayout extends ViewGroup {

    private int mRowCount;
    private int mColumnCount;

    public prototypePadLayout(Context context) {
        this(context, null);
    }

    public prototypePadLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public prototypePadLayout(Context context, AttributeSet attrs, int defStyle) {
